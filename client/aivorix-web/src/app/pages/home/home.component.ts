  ...
  template: `
      ...
      <div class="container">
        <div class="benchmark-intro">
          <div>
            ...
            <h1>
              There is no single “best AI.”<br /><span>The task decides.</span>
            </h1>
          </div>
          ...
          <div class="benchmark-stage" role="tabpanel">
            <div class="chart-column">
              ...
              <div class="bar-chart" aria-label="Benchmark score chart">
                ...
                @for (
                  entry of currentBenchmark.entries;
                  track entry.toolSlug;
                  let rank = $index
                ) {
                  <div class="bar-row">
                    <a
            ...
            <aside class="evidence-card">
              ...
              <div class="source-grade">
                <span></span>{{ currentBenchmark.sourceType }}
              </div>
              ...
              <a
                [href]="currentBenchmark.sourceUrl"
                target="_blank"
        ...
        <div class="signal-heading">
          ...
          <p>
            These cards use different task-specific measurements and are not a
            shared ranking.
          </p>
        </div>
        ...
        <p class="benchmark-disclaimer">
          Benchmark scores are snapshots, not guarantees. Model effort, agent
          harness, tools, product plan and test date can change the result.
        </p>
      </div>
    </section>
        ...
        <div class="news-grid">
          @for (article of news.slice(0, 6); track article.slug) {
            <article class="card news-card">
              ...
              <p>{{ article.summary }}</p>
              <div class="source">Source: {{ article.sourceName }}</div>
            </article>
          }
        </div>
      </div>
    ...
    <section class="section">
      <div class="container newsletter card">
        <div>
          <span class="eyebrow">Weekly brief</span>
          <h2>One useful AI email. No hype dump.</h2>
          <p>
            New model releases, major pricing changes and the comparisons worth
            revisiting.
          </p>
        </div>
        <form
